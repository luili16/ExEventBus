...
public class SubscribeEntry9 {
    ...
    @Subscriber(tag = "event10_SubscribeEntry9",model = ThreadModel.HANDLER,type = Type.BLOCK_RETURN,remote = true)
    public String testMethod3(Event10 event10) {
        assertNotNull(event10);
        return "return_"+event10.getMsg();
    }

    @Subscriber(tag = "event11_SubscribeEntry9",model = ThreadModel.POST,type = Type.BLOCK_RETURN,remote = true)
